                  ...
                  PieChartData(
                    ...
                    sections: controller.orderStatusData.entries.map((entry) {
                      ...
                      return PieChartSectionData(
                        ...
                        radius: ADeviceUtils.isTabletScreen(context) ? 80 : 100,
          ...
          child: Obx(
            () => DataTable(
              ...
              rows: controller.orderStatusData.entries.map((entry) {
                ...
                final String displayStatus = controller.getOrderStatusName(status);
                ...
                return DataRow(
                  cells: [
                    DataCell(
                      Row(
                        children: [
                          ACircularContainer(width: 20,height: 20,backgroundColor: AHelperFunctions.getOrderStatusColor(status),),
